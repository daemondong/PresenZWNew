...
static uint8_t powerlevelTimerHandle = 0;
...
{
  TimerCancel(powerlevelTimerHandle);
  powerlevelTimerHandle = 0;
}
  ...
  switch (pCmd->ZW_Common.cmd)
  {
    case POWERLEVEL_SET:
      ...
      else
      {
        ...
        powerlevelTimerHandle = TimerStart(ZCB_PowerLevelTimeout, TIMER_ONE_SECOND,
        TIMER_FOREVER);

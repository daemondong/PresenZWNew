      ...
      switch (serFrameCmd)
      {
        ...
        case FUNC_ID_ZW_SET_LEARN_MODE:
          ...
          else
          {
            ...
            ZW_NetworkLearnModeStart(serFrameDataPtr[0] - SERIALPI_SET_LEARN_MODE_LEARN_PLUS_OFFSET);
          }
          ...
          if ((FRAME_LENGTH_MIN + 1) <= serFrameLen)
          {
            ...
            switch (serFrameDataPtr[0])
            {
              ...
              case SERIAL_API_SETUP_CMD_TX_POWERLEVEL_SET:
                /* HOST->ZW: SERIAL_API_SETUP_CMD_TX_POWERLEVEL_SET | NormalPowerCh0 | NormalPowerCh1 |
              ...
              case SERIAL_API_SETUP_CMD_TX_POWERLEVEL_GET:
                /* HOST->ZW: SERIAL_API_SETUP_CMD_TX_POWERLEVEL_GET
                 * ZW->HOST: SERIAL_API_SETUP_CMD_TX_POWERLEVEL_GET | config |

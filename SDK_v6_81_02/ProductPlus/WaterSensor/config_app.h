...
#define APP_ICON_TYPE ICON_TYPE_SPECIFIC_SENSOR_NOTIFICATION_WATER_ALARM
#define APP_USER_ICON_TYPE ICON_TYPE_SPECIFIC_SENSOR_NOTIFICATION_WATER_ALARM
//@ [APP_TYPE_ID]
...
#define  AGITABLE_ROOTDEVICE_GROUPS \
  {ASSOCIATION_GROUP_INFO_REPORT_PROFILE_NOTIFICATION, NOTIFICATION_REPORT_WATER_V4, {COMMAND_CLASS_BASIC, BASIC_SET}, "Basic set"}
//@ [AGITABLE_ROOTDEVICE_GROUPS_no_endpoints]
//@ [AGI_TABLE_ID]

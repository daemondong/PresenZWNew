  ...
  BYTE cmdLength)
{
  ...
  switch (pCmd->ZW_Common.cmd)
  {
    ...
    case EVENT_SUPPORTED_GET_V4:
      ...
      return RECEIVED_FRAME_STATUS_FAIL;
      break;
#ifdef NOTI_RPT   //client support notification report for inter-connect
	case NOTIFICATION_REPORT_V4:
	  handleNoti_Rpt(pCmd->ZW_NotificationReport1byteV4Frame.notificationType,pCmd->ZW_NotificationReport1byteV4Frame.mevent);
	  break;
#endif
    default:

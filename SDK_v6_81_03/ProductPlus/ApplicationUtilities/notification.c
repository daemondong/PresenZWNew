...
#ifdef DEBUG_WITH_TI
  tt[0]=myNotification.grp[myNotification.lastActionGrp].agiProfile.profile_MS;
  tt[1]=pProfile->profile_MS;
  tt[2]=myNotification.grp[myNotification.lastActionGrp].agiProfile.profile_LS;
  tt[3]=pProfile->profile_LS;
  tt[4]=myNotification.grp[myNotification.lastActionGrp].trigged;
  tt[5]=myNotification.grp[myNotification.lastActionGrp].type;
  tt[6]=myNotification.grp[myNotification.lastActionGrp].ep;
  MakeDebugStr(tt, 7);
  ZW_UART0_tx_send_str(debugStr);
#endif
